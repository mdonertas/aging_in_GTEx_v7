...
att = read_tsv('./data/raw/GTEx_v7_Annotations_SampleAttributesDS.txt')
phe = read_tsv('./data/raw/GTEx_v7_Annotations_SubjectPhenotypesDS.txt')
...
dat=fread('./data/raw/expression/GTEx_Analysis_2016-01-15_v7_RNASeQCv1.1.8_gene_tpm.gct')
samplesx=colnames(dat)
